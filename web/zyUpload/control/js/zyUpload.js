    ...
    $.fn.zyUpload = function (options, param) {
        ...
        return this.each(function () {
            ...
            this.createHtml = function () {
                ...
                //添加一个选择提示
                var loadHtml = '';
                loadHtml += '<div class="overlay"></div>';
                loadHtml += '<div id="AjaxLoading" class="showbox">';
                loadHtml += '<div class="loadingWord"><img src="zyUpload/control/images/waiting.gif">正在选择图片中...</div>';
                loadHtml += '</div>';
                $(self).append(loadHtml);
                // 初始化html之后绑定按钮的点击事件
                this.addEvent();
            };
            ...
            this.funDisposePreviewHtml = function (file, e) {
                ...
                // 处理不同类型文件代表的图标
                var fileImgSrc = MyUtil.getContext() + "zyUpload/control/images/fileType/";
...
//						$("#uploadInf").append("<p>上传成功，文件地址是：" + response + "</p>");
                        if (typeof(uploadImgSuccess) == "function") {
