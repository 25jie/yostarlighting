$(document).ready(function(){
    	...
    	$("#addBtn").click(function(){
    		window.location.href=MyUtil.getContext()+"backgroundPages/jsp/contactus/addContactus.jsp";
    	});
    	//编辑
    	$("#editBtn").click(function(){
    		...
    		window.location.href=MyUtil.getContext()+"backgroundPages/jsp/contactus/addContactus.jsp?objectId="+_ckid;
    	});
    	//全选
...
function useArticle(id,obj){
	$.post('useArticle.do',{'article_id':id,'article_categoryDM':'CONTACTUS','needshow':'Y'},function(result){
