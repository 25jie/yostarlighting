 $(document).ready(function(){
    //初始化类别
	 $.post("getMenu.do",{"navigation_name":"招聘信息","navigation_type":"QT"},function(result){
 		  ...
 		  if(!checkNull()){
 			  $.ajax({
 		            ...
 		            success:function(result){
 		            	alert("保存成功");
 		            	var obj=eval("("+result+")");
 		            	window.location.href=MyUtil.getContext()+"backgroundPages/jsp/career/manageCareer.jsp?objectId="+obj.article_id;
 		           }
 				});
 		  }
 	   });
