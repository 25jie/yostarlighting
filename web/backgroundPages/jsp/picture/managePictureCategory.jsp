...
<head>
    ...
    <script type="text/javascript" src="backgroundPages/js/picture/managePictureCategory.js"></script>
            ...
            <table width="100%" border="0" cellpadding="0" cellspacing="0" class="list_table">
                <tr>
                    <th width="80">
                        ...
                        <input type="button" name="button" id="ckNo" class="btn btn82 btn_nochecked"
